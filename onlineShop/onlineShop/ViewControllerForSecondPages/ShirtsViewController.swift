...
class ShirtsViewController: UIViewController {
    var segmentName3 = UISegmentedControl()
    var nameArray3 = ["1", "2", "3", "4", "5"]
    var shirtsImages = UIImageView()
    var shirtsImagesArray = [UIImage(named: "shirt"), UIImage(named: "shirt2"), UIImage(named: "shirt3"), UIImage(named: "shirt4"), UIImage(named: "shirt5")]
    ...
    override func viewDidLoad() {
        ...
        self.shirtsImages.frame = CGRect(x: 50, y: 180, width: 300, height: 250)
        self.shirtsImages.image = shirtsImagesArray[1]
        self.view.addSubview(shirtsImages)
        
        //segment
        self.segmentName3 = UISegmentedControl(items: nameArray3)
        self.segmentName3.frame = CGRect(x: 90, y: 450, width: 200, height: 40)
        self.view.addSubview(segmentName3)
        self.segmentName3.addTarget(self, action: #selector(selectImage2), for: .valueChanged)
        self.segmentName3.addTarget(self, action: #selector(selectPrice), for: .valueChanged)
    ...
    @objc func selectImage2 (target : UISegmentedControl) {
        if target == self.segmentName3 {
            let segmentIndex = target.selectedSegmentIndex
            self.shirtsImages.image = self.shirtsImagesArray[segmentIndex]
        }
...
extension ShirtsViewController :  UIPickerViewDelegate, UIPickerViewDataSource {
